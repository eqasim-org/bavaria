...
def configure(context):
    ...
    context.stage("germany.data.mid.data")
    context.stage("germany.data.mid.zones")
...
def execute(context):
    ...
    # load MiD
    df_zones = context.stage("germany.data.mid.zones")
    mid = context.stage("germany.data.mid.data")
