...
# df_buildings = gpd.read_file("C:/Users/arthur.burianne/Documents/sources_data/fake_data_munich/bdtopo_idf/091_Oberbayern_Hausumringe/hausumringe.shp",engine="pyogrio",arrow=True)
# df_buildings["area"] = df_buildings.area
# df_buildings["area"].plot()
...
# df_census = pd.read_pickle(tmp_path + "data.census.raw__bae49205a1e9b09da2324345552c5d19.p")
