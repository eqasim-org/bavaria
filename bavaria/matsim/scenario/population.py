...
def add_person(writer, person, activities, trips, vehicles):
    ...
    # Bavaria: use String instead of Double
    writer.add_attribute("householdIncome", "java.lang.String", person[PERSON_FIELDS.index("household_income")])
   
    # Bavaria: Added
    writer.add_attribute("highIncome", "java.lang.Boolean", person[PERSON_FIELDS.index("high_income")])
