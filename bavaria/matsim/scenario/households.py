...
def add_household(writer, household, member_ids):
    ...
    writer.add_attribute("household_income", "java.lang.String", household[FIELDS.index("household_income")])
    # Bavaria: Added
    writer.add_attribute("high_income", "java.lang.Boolean", household[FIELDS.index("high_income")])
